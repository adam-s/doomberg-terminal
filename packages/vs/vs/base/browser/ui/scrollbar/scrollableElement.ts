...
} from 'vs/base/browser/ui/scrollbar/scrollableElementOptions';
  ...
  private _setListeningToMouseWheel(shouldListen: boolean): void {
    ...
    if (shouldListen) {
      ...
      this._mouseWheelToDispose.push(
        dom.addDisposableListener(this._listenOnDomNode, dom.EventType.MOUSE_WHEEL, onMouseWheel, { passive: false }),
      );
    }
  }
    ...
    if (e.deltaY || e.deltaX) {
      ...
      if (deltaY) {
        ...
        const desiredScrollTop =
          futureScrollPosition.scrollTop -
      ...
      if (deltaX) {
        ...
        const desiredScrollLeft =
          futureScrollPosition.scrollLeft -
      ...
      if (
        futureScrollPosition.scrollLeft !== desiredScrollPosition.scrollLeft ||
...
function resolveOptions(opts: ScrollableElementCreationOptions): ScrollableElementResolvedOptions {
  const result: ScrollableElementResolvedOptions = {
    ...
    consumeMouseWheelIfScrollbarIsNeeded:
      typeof opts.consumeMouseWheelIfScrollbarIsNeeded !== 'undefined'
        ? opts.consumeMouseWheelIfScrollbarIsNeeded
        : false,
    alwaysConsumeMouseWheel: typeof opts.alwaysConsumeMouseWheel !== 'undefined' ? opts.alwaysConsumeMouseWheel : false,
    scrollYToX: typeof opts.scrollYToX !== 'undefined' ? opts.scrollYToX : false,
    mouseWheelScrollSensitivity:
      typeof opts.mouseWheelScrollSensitivity !== 'undefined' ? opts.mouseWheelScrollSensitivity : 1,
  ...
  result.horizontalSliderSize =
    typeof opts.horizontalSliderSize !== 'undefined' ? opts.horizontalSliderSize : result.horizontalScrollbarSize;
  result.verticalSliderSize =
    typeof opts.verticalSliderSize !== 'undefined' ? opts.verticalSliderSize : result.verticalScrollbarSize;
