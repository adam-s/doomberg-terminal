...
describe('Icon Labels', () => {
  ...
  it('matchesFuzzyIconAware', () => {
    ...
    // Testing #136172
    filterOk(matchesFuzzyIconAware, 's', parseLabelWithIcons('$(loading~spin) start'), [{ start: 16, end: 17 }]);
  });
