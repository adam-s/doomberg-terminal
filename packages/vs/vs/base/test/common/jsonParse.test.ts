...
describe('JSON Parse', () => {
  ...
  it('Trailing comma', () => {
    const content: string = ['{', '  "propA": 10, // a comment', '  "propB": false, // a trailing comma', '}'].join(
      '\n',
    );
