...
import {
  ...
  TernarySearchTree,
  UriIterator,
} from 'vs/base/common/ternarySearchTree';
...
describe('Ternary Search Tree', () => {
  ...
  it('URIIterator - ignore query/fragment', function () {
    const iter = new UriIterator(
      () => false,
      () => true,
    );
  ...
  it('TernarySearchTree - set', function () {
  ...
  it('TernarySearchTree - findLongestMatch', function () {
  ...
  it('TernarySearchTree - basics', function () {
  ...
  it('TernarySearchTree - delete & cleanup', function () {
    // normal delete
  ...
  it('TernarySearchTree (PathSegments) - basics', function () {
  ...
  it('TernarySearchTree - (AVL) set', function () {
    {
      // rotate left
      const trie = new TernarySearchTree<string, number>(new PathIterator());
      trie.set('/fileA', 1);
  ...
  it('TernarySearchTree - (BST) delete', function () {
    const trie = new TernarySearchTree<string, number>(new StringIterator());
  ...
  it('TernarySearchTree - (AVL) delete', function () {
    const trie = new TernarySearchTree<string, number>(new StringIterator());
  ...
  it("TernarySearchTree: Cannot read property '1' of undefined #138284", function () {
    const keys = [URI.parse('fake-fs:/C'), URI.parse('fake-fs:/A'), URI.parse('fake-fs:/D'), URI.parse('fake-fs:/B')];
  ...
  it("TernarySearchTree: Cannot read property '1' of undefined #138284 (simple)", function () {
    const keys = ['C', 'A', 'D', 'B'];
  ...
  it("TernarySearchTree: Cannot read property '1' of undefined #138284 (random)", function () {
  ...
  it("TernarySearchTree: Cannot read properties of undefined (reading 'length'): #161618 (simple)", function () {
    const raw =
  ...
  it("TernarySearchTree: Cannot read properties of undefined (reading 'length'): #161618 (random)", function () {
    const raw =
      'config.debug.toolBarLocation,floating,config.editor.renderControlCharacters,true,config.editor.renderWhitespace,selection,config.files.autoSave,off,config.git.enabled,true,config.notebook.globalToolbar,true,config.terminal.integrated.tabs.enabled,true,config.terminal.integrated.tabs.showActions,singleTerminalOrNarrow,config.terminal.integrated.tabs.showActiveTerminal,singleTerminalOrNarrow,config.workbench.activityBar.visible,true,config.workbench.experimental.settingsProfiles.enabled,true,config.workbench.layoutControl.type,both,config.workbench.sideBar.location,left,config.workbench.statusBar.visible,true';
    const array = raw.split(',');
    const tuples: [string, string][] = [];
  ...
  it('TernarySearchTree (PathSegments) - lookup', function () {
  ...
  it('TernarySearchTree (PathSegments) - superstr', function () {
    const map = new TernarySearchTree<string, number>(new PathIterator());
    map.set('/user/foo/bar', 1);
    map.set('/user/foo', 2);
    map.set('/user/foo/flip/flop', 3);
  ...
  it('TernarySearchTree (PathSegments) - delete_superstr', function () {
    const map = new TernarySearchTree<string, number>(new PathIterator());
    map.set('/user/foo/bar', 1);
    map.set('/user/foo', 2);
    map.set('/user/foo/flip/flop', 3);
  ...
  it('TernarySearchTree (URI) - basics', function () {
  ...
  it('TernarySearchTree (URI) - query parameters', function () {
    const trie = new TernarySearchTree<URI, number>(
      new UriIterator(
        () => false,
        () => true,
  ...
  it('TernarySearchTree (URI) - lookup', function () {
  ...
  it('TernarySearchTree (URI) - lookup, casing', function () {
    const map = new TernarySearchTree<URI, number>(
      new UriIterator(
  ...
  it('TernarySearchTree (URI) - superstr', function () {
    const map = new TernarySearchTree<URI, number>(
      new UriIterator(
        () => false,
        () => false,
  ...
  it('TernarySearchTree (ConfigKeySegments) - basics', function () {
  ...
  it('TernarySearchTree (ConfigKeySegments) - lookup', function () {
  ...
  it('TernarySearchTree (ConfigKeySegments) - superstr', function () {
    const map = new TernarySearchTree<string, number>(new ConfigKeysIterator());
    map.set('config.foo.bar', 1);
    map.set('config.foo', 2);
    map.set('config.foo.flip.flop', 3);
  ...
  it('TernarySearchTree (ConfigKeySegments) - delete_superstr', function () {
    const map = new TernarySearchTree<string, number>(new ConfigKeysIterator());
    map.set('config.foo.bar', 1);
    map.set('config.foo', 2);
    map.set('config.foo.flip.flop', 3);
