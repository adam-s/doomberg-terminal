...
describe('Buffer', () => {
  ...
  it('issue #71993 - VSBuffer#toString returns numbers', () => {
  ...
  it('bufferToReadable / readableToBuffer', () => {
  ...
  it('bufferToStream / streamToBuffer', async () => {
    const content = 'Hello World';
  ...
  it('bufferedStreamToBuffer', async () => {
    const content = 'Hello World';
  ...
  it('bufferWriteableStream - basics (no error)', async () => {
  ...
  it('bufferWriteableStream - basics (error)', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('bufferWriteableStream - buffers data when no listener', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('bufferWriteableStream - buffers errors when no listener', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('bufferWriteableStream - buffers end when no listener', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('bufferWriteableStream - nothing happens after end()', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('bufferWriteableStream - pause/resume (simple)', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('bufferWriteableStream - pause/resume (pause after first write)', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('bufferWriteableStream - pause/resume (error)', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('bufferWriteableStream - destroy', async () => {
    const stream = newWriteableBufferStream();
  ...
  it('Performance issue with VSBuffer#slice #76076', function () {
