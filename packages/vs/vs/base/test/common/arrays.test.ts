...
describe('Arrays', () => {
  ...
  it('removeFastWithoutKeepingOrder', () => {
  ...
  it('delta sorted arrays', function () {
    function compare(a: number, b: number): number {
      return a - b;
    }
  ...
  it('distinct', () => {
    ...
    assert.deepStrictEqual(arrays.distinct(['32', 'constructor', 'proto', 'proto', 'constructor'], compare), [
      '32',
      'constructor',
      'proto',
    ]);
    assert.deepStrictEqual(arrays.distinct(['32', '4', '5', '32', '4', '5', '32', '4', '5', '5'], compare), [
      '32',
      '4',
      '5',
    ]);
  ...
  describe('ArrayQueue', () => {
    ...
    describe('takeWhile/takeFromEndWhile monotonous', () => {
      ...
      it('TakeWhile 1', () => testMonotonous(array, value => value <= 1));
      it('TakeWhile 2', () => testMonotonous(array, value => value < 5));
      it('TakeWhile 3', () => testMonotonous(array, value => value <= 5));
      it('TakeWhile 4', () => testMonotonous(array, value => true));
      it('TakeWhile 5', () => testMonotonous(array, value => false));

      const array2 = [1, 1, 1, 2, 5, 5, 7, 8, 8, 9, 9, 9, 9, 10, 10];

      it('TakeWhile 6', () => testMonotonous(array2, value => value < 10));
      it('TakeWhile 7', () => testMonotonous(array2, value => value < 7));
      it('TakeWhile 8', () => testMonotonous(array2, value => value < 5));

      it('TakeWhile Empty', () => testMonotonous([], value => value <= 5));
    });
  });
});
