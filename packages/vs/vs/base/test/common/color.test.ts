...
describe('Color', () => {
  ...
  it('isLighterColor', () => {
    const color1 = new Color(new HSLA(60, 1, 0.5, 1)),
      color2 = new Color(new HSLA(0, 0, 0.753, 1));
  ...
  it('blending', () => {
    assert.deepStrictEqual(
      new Color(new RGBA(0, 0, 0, 0)).blend(new Color(new RGBA(243, 34, 43))),
      new Color(new RGBA(243, 34, 43)),
    );
    assert.deepStrictEqual(
      new Color(new RGBA(255, 255, 255)).blend(new Color(new RGBA(243, 34, 43))),
  ...
  describe('HSVA', () => {
    ...
    it('Keep hue value when saturation is 0', () => {
