...
describe('Strings', () => {
  ...
  it('compareIgnoreCase (substring)', () => {
  ...
  it('issue #115221: isEmojiImprecise misses ⭐', () => {
  ...
  it('containsUppercaseCharacter (ignoreEscapedChars)', () => {
    [
      ['\\Woo', false],
      ['f\\S\\S', false],
      ['foo', false],
  ...
  it('removeAnsiEscapeCodesFromPrompt', () => {
