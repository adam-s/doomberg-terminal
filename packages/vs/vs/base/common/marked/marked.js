...
(<reference path="marked.d.ts" />)(function (global, factory) {
    ...
    _proto.list = function list(src) {
      ...
      if (cap) {
        ...
        while (src) {
          ...
          if (!endEarly) {
            var nextBulletRegex = new RegExp(
              '^ {0,' + Math.min(3, indent - 1) + '}(?:[*+-]|\\d{1,9}[.)])((?: [^\\n]*)?(?:\\n|$))',
            );
            var hrRegex = new RegExp(
  ...
  var Lexer = /*#__PURE__*/ (function () {
    ...
    _proto.inlineTokens = function inlineTokens(src, tokens) {
      ...
      while ((match = this.tokenizer.rules.inline.escapedEmSt.exec(maskedSrc)) != null) {
        maskedSrc =
          maskedSrc.slice(0, match.index) + '++' + maskedSrc.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex);
      }
    ...
    _proto.parseInline = function parseInline(tokens, renderer) {
      ...
      for (i = 0; i < l; i++) {
        ...
        if (
          ...
          if (
            ret !== false ||
            !['escape', 'html', 'link', 'image', 'strong', 'em', 'codespan', 'br', 'del', 'text'].includes(token.type)
          ) {
            out += ret || '';
            continue;
          }
  ...
  function marked(src, opt, callback) {
    ...
    try {
      ...
      if (opt.walkTokens) {
        if (opt.async) {
          return Promise.all(marked.walkTokens(_tokens, opt.walkTokens))
            .then(function () {
  ...
  marked.walkTokens = function (tokens, callback) {
    ...
    var _loop3 = function _loop3() {
      ...
      switch (token.type) {
        case 'table': {
          for (
            var _iterator2 = _createForOfIteratorHelperLoose(token.header), _step2;
  ...
  marked.parseInline = function (src, opt) {
    ...
    if (typeof src !== 'string') {
      throw new Error(
        'marked.parseInline(): input parameter is of type ' + Object.prototype.toString.call(src) + ', string expected',
      );
    }
