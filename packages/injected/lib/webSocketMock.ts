...
export type OnClosePagePayload = {
  type: 'onClosePage';
  id: string;
...
export type OnCloseServerPayload = {
  type: 'onCloseServer';
  id: string;
  code: number | undefined;
  reason: string | undefined;
...
export type BindingPayload =
  | OnCreatePayload
  | OnMessageFromPagePayload
  | OnMessageFromServerPayload
  | OnClosePagePayload
  | OnCloseServerPayload;
...
export type CloseServerRequest = {
  type: 'closeServer';
  id: string;
  code: number | undefined;
  reason: string | undefined;
